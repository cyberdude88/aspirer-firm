...
- **Google Calendar OAuth** — owner account integration for booking creation
...
For production on `https://aspirerfirm.com`, set `NEXT_PUBLIC_SITE_URL=https://aspirerfirm.com`.
...
1. **Google Cloud** — create OAuth client credentials for the Calendar owner account and enable Google Calendar API. Save the client ID/secret.
